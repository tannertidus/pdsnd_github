...
def time_stats(df):
    ...
    most_common_m = df['month'].mode()[0]
    print('Most Popular month:', months[most_common_m-1].title())
    print()

    # display the most common day of week
    most_common_d = df['day_of_week'].mode()[0] 
    print('Most Popular day:', most_common_d.title())
    print()
